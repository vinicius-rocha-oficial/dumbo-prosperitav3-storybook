import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{S as E,a as C}from"./index-ClYmvwGD.js";import{t as n}from"./contextual-D4vCP4YA.js";import{d as l}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import"./index-CTjT7uj6.js";const m=l.div`
  border-radius: 24px;
  display: flex;
  flex-direction: row;
  ...
  gap: 7px;
  align-items: center;
  padding-right: ${({filter:r})=>r?"0px":"10px"};
  padding-left: ${({renderIcon:r})=>r?"0px":"10px"};
  cursor: context-menu;
  position: relative;
`,g=l.p`
  margin: 0;
...
`,S={blue:"#D0E2FF",cyan:"#BAE6FF",green:n.tagBackgroundGreen,magenta:"#FFD6E8",skeleten:n.skeletonElement,gray:n.tagBackgroundWarmGray,focus:n.focus,inverse:n.backgroundInverse},d={blue:"#0043CE",cyan:"#00539A",green:n.tagColorGreen,magenta:"#9F1853",skeleten:n.skeletonElement,gray:n.tagColorWarmGray,focus:n.focus,inverse:n.iconInverse},w=r=>{const{type:a,label:T,filter:c,renderIcon:t,loading:F,children:L}=r;return e.jsx(e.Fragment,{children:F?e.jsx(e.Fragment,{children:e.jsx(E,{baseColor:n.skeletonElement,highlightColor:n.skeletonBackground,children:e.jsxs(m,{type:a,...r,children:[t&&e.jsx("img",{src:t,style:{boxSizing:"border-box",padding:"0",margin:"0 0 0 10px",width:"15px"}}),e.jsx(C,{count:1,style:{position:"absolute",top:"0",right:"0",left:"0",bottom:"0",borderRadius:"24px",display:"flex"}}),e.jsx(g,{...r,children:T||"Tag content"}),c&&e.jsx(e.Fragment,{children:e.jsx(p,{type:a,...r})})]})})}):e.jsx(e.Fragment,{children:e.jsxs(m,{type:a,...r,children:[t&&e.jsx("img",{src:t,style:{boxSizing:"border-box",padding:"0",margin:"0 0 0 10px",width:"15px"}}),e.jsx(g,{...r,children:L||"Text Exemplo"}),c&&e.jsx(e.Fragment,{children:e.jsx(p,{type:a,...r,children:e.jsx("svg",{width:"15px",height:"15px",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e.jsxs("g",{id:"Close",children:[e.jsx("rect",{width:"10px",height:"10px"}),e.jsx("path",{id:"Vector",d:"M12 4.7L11.3 4L8 7.3L4.7 4L4 4.7L7.3 8L4 11.3L4.7 12L8 8.7L11.3 12L12 11.3L8.7 8L12 4.7Z",fill:d[a||"blue"]})]})})})})]})})})};w.__docgenInfo={description:"",methods:[],displayName:"Tag",props:{type:{required:!1,tsType:{name:"union",raw:`| "blue"\r
| "cyan"\r
| "green"\r
| "magenta"\r
| "skeleten"\r
