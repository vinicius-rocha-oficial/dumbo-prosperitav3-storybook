import{j as t}from"./jsx-runtime-Cw0GR0a5.js";import{r as M}from"./index-CTjT7uj6.js";import{d as o}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as a}from"./contextual-D4vCP4YA.js";import{s as z}from"./statusicon-BiyrYhQW.js";import{w as k}from"./Warningfilled-CR6tEm8M.js";const C=o.div`
  ...
  padding: 0;
  width: ${({label:e,radio:r})=>e||r?"auto":"18px"};
...
`,u=o.input`
  ...
  width: 17px;
  height: 17px;
  border: ${({error:e,disabled:r})=>e?`2px solid ${a.supportError}`:r?`1px solid ${a.borderDisabled}`:`1px solid ${a.textPrimary}`};
  border-radius: 100%;
  position: relative;
  align-items: center;
...
`,S=o.p`
  ...
  cursor: pointer;
  margin: 0;
`,I=e=>{const{warning:r,error:n,disabled:l,title:j,onChange:E,InvalidText:R,texthelp:$,orientation:L,radio:p,label:m,name:q,value:x}=e;return t.jsxs(t.Fragment,{children:[t.jsx(P,{...e,children:j}),t.jsx(t.Fragment,{children:t.jsx(C,{orientation:L,label:m,...e,children:(p==null?void 0:p.map((i,c)=>M.createElement(g,{disabled:l,...e,key:c},t.jsx(u,{type:"radio",name:i.name,value:i.value,onChange:i.onChange,id:i.value,disabled:l,error:n},c),t.jsx(h,{for:i.value,...e,children:i.label}))))||t.jsx(t.Fragment,{children:t.jsxs(g,{disabled:l,...e,children:[t.jsx(u,{type:"radio",disabled:l,label:m,value:x,name:q,onChange:E,id:x,error:n}),t.jsx(h,{for:x,...e,children:m})]})})})}),t.jsxs(t.Fragment,{children:[!n&&!r&&t.jsx(S,{disabled:l,...e,children:$}),(n||r)&&t.jsx(t.Fragment,{children:t.jsxs("div",{style:{display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"start",gap:"5px",margin:"0",width:"100%"},children:[t.jsx("img",{src:n?k:z,style:{width:"15px",height:"15px",margin:"0"}}),t.jsx("p",{style:{margin:"0",fontFamily:"IBM Plex Sans",fontSize:"12px",color:n?a.textError:a.textPrimary},children:R})]})})]})]})};I.__docgenInfo={description:"",methods:[],displayName:"Radio",props:{disabled:{required:!1,tsType:{name:"boolean"},description:""},error:{required:!1,tsType:{name:"boolean"},description:""},warning:{required:!1,tsType:{name:"boolean"},description:""},title:{required:!1,tsType:{name:"string"},description:""},InvalidText:{required:!1,tsType:{name:"string"},description:""},for:{required:!1,tsType:{name:"string"},description:""},orientation:{required:!1,tsType:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}]},description:""},texthelp:{required:!1,tsType:{name:"string"},description:""},radio:{required:!1,tsType:{name:"Array",elements:[{name:"intersection",raw:`InputHTMLAttributes<HTMLInputElement> & {\r
  label?: string;\r
  name?: string;\r
  value?: string;\r
