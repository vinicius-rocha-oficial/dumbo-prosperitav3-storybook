...
`,h={position:"absolute",top:"0",bottom:"0",left:"0",right:"0",borderRadius:"2px"},K=e=>{const{size:g,label:d,messege:p,disabled:n,loading:E}=e;return t.jsx(t.Fragment,{children:E?t.jsx(t.Fragment,{children:t.jsx(R,{baseColor:s.skeletonElement,highlightColor:s.skeletonBackground,children:t.jsxs("div",{style:{margin:"0",textAlign:"left",position:"relative"},children:[d&&t.jsx(t.Fragment,{children:t.jsx("div",{style:{display:"flex",alignSelf:"flex-start"},children:t.jsxs(x,{style:{position:"relative"},disabled:n,...e,children:[d,t.jsx(c,{count:1,style:h})]})})}),t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px",margin:"0"},children:[t.jsxs(u,{...e,children:[t.jsx(m,{type:"checkbox",...e}),t.jsx(a,{size:g,...e}),t.jsx(c,{count:1,style:{borderRadius:"81px",position:"absolute",top:"0",bottom:"0",left:"0",right:"0"}})]}),t.jsx("div",{style:{display:"flex",alignSelf:"flex-start"},children:t.jsxs(f,{style:{position:"relative"},disabled:n,...e,children:[p,t.jsx(c,{count:1,style:h})]})})]})]})})}):t.jsxs("div",{style:{margin:"0",textAlign:"left"},children:[t.jsx(x,{disabled:n,...e,children:d}),t.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px",margin:"0"},children:[t.jsxs(u,{...e,children:[t.jsx(m,{type:"checkbox",...e}),t.jsx(a,{size:g,...e})]}),t.jsx(f,{disabled:n,...e,children:p})]})]})})};K.__docgenInfo={description:"",methods:[],displayName:"Toogle",props:{size:{required:!1,tsType:{name:"union",raw:'"small" | "default"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"default"'}]},description:""},label:{required:!1,tsType:{name:"string"},description:""},messege:{required:!1,tsType:{name:"string"},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:""},checked:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.ChangeEvent<HTMLInputElement>) => void",signature:{arguments:[{type:{name:"ReactChangeEvent",raw:"React.ChangeEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},name:"event"}],return:{name:"void"}}},description:""}}};const V={title:"Example/Toogle",component:K,parameters:{layout:"centered"},tags:["autodocs"]},o={args:{label:"Toggle label",size:"default",messege:"Value"}},i={args:{label:"Toggle label",size:"default",messege:"Value",disabled:!0}},r={args:{label:"Toggle label",size:"default",messege:"Value",checked:!0}};var b,A,y;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    label: "Toggle label",
    size: "default",
    messege: "Value"
