import{j as n}from"./jsx-runtime-Cw0GR0a5.js";import{r as x}from"./index-CTjT7uj6.js";import{d as u}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as r}from"./contextual-D4vCP4YA.js";import{f as c}from"./IconsInputLabel-E66WMmAT.js";const v=u.div`
  display: flex;
  ...
  position: relative;
`,D={small:"7px 155px 7px 16px",large:"17px 155px 17px 15px",medium:"11px 155px 11px 16px"},k={large:"14px",medium:"12px",small:"8px"},j=u.button`
...
`,w=e=>{const{selectedIndex:l,disabled:i,options:a,type:C}=e,[s,m]=x.useState(l);x.useEffect(()=>{m(l)},[l]);const S=(o,t)=>{m(o),a[o].onClick&&a[o].onClick(t)};return n.jsx(v,{...e,children:a.map((o,t)=>n.jsxs(n.Fragment,{children:[n.jsxs(j,{style:{background:s===t&&i?r.buttonDisabled:s===t?r.layerSelectedInverse:"transparent",color:s===t&&i?r.textDisabled:i?r.borderDisabled:s===t?r.textInverse:r.textSecondary,border:s===t&&i?`1px solid ${r.borderDisabled}`:"",outline:s===t&&i?`2px solid ${r.borderDisabled}`:"",borderRadius:t===0&&a.length>1?"2px 0px 0px 2px":t===a.length-1&&a.length>1?"0px 2px 2px 0px":""},onClick:T=>S(t,T),...e,children:[n.jsxs(n.Fragment,{children:[C==="default"?n.jsx(n.Fragment,{children:o.label}):n.jsx("div",{children:String(o==null?void 0:o.IconType)})," "]}),n.jsx("span",{style:{padding:"0",margin:"0",position:"absolute",right:"12px"},children:n.jsx("img",{style:{padding:"0",margin:"0"},src:o.IconDefault})})]},t),t>=0&&t<a.length-1&&n.jsx(E,{style:{margin:"0",padding:"0"}})]}))})};w.__docgenInfo={description:"",methods:[],displayName:"ContentSwitcher",props:{size:{required:!0,tsType:{name:"union",raw:'"small" | "large" | "medium"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"large"'},{name:"literal",value:'"medium"'}]},description:""},selectedIndex:{required:!0,tsType:{name:"number"},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},options:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`ButtonHTMLAttributes<HTMLButtonElement> & {\r
  label?: string;\r
