import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{r as x}from"./index-CTjT7uj6.js";import{d as n}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as r}from"./contextual-D4vCP4YA.js";import{A as b}from"./IconsInputLabel-DNdvQB1m.js";const y=n.div`
  cursor: pointer;
  color: ${r.textPrimary};
  ...
  &:hover {
    background: ${r.borderSubtle01};
  }
  &:focus {
    border: 2px solid #29183a;
  }
  &:active {
    border: 2px solid ${r.backgroundActive};
  }
`,f=n.section`
  margin: 0;
  padding: 0;
