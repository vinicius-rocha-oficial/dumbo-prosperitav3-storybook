import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{d as t}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as i}from"./contextual-D4vCP4YA.js";import{l as x}from"./IconsInputLabel-DNdvQB1m.js";import"./index-CTjT7uj6.js";const f=t.table`
...
`,w=t.input`
  display: none;
  &:checked + ${o} {
    background: ${i.backgroundSelected};
...
`,c=({columns:g,rows:b})=>e.jsxs(f,{children:[e.jsx(k,{children:g.map((n,a)=>e.jsx("label",{style:{display:"contents"},children:e.jsx(h,{onClick:n.onClick,children:n.label})},n.key||a))}),b.map((n,a)=>{var l;return e.jsxs("label",{style:{display:"contents"},children:[e.jsx(w,{type:"radio",name:"id",value:n.value}),e.jsxs(o,{tabIndex:0,children:[(l=n.options)==null?void 0:l.map((r,y)=>e.jsx(v,{onClick:r.onClick,children:r==null?void 0:r.label},y)),e.jsx(m,{style:{margin:"0",padding:"0 25px 0 5px"},children:x})]})]},a)})]});c.__docgenInfo={description:"",methods:[],displayName:"StructuredList",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  key?: string;
  onClick?: () => void;
}`,signature:{properties:[{key:"label",value:{name:"string",required:!0}},{key:"key",value:{name:"string",required:!1}},{key:"onClick",value:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}},required:!1}}]}}],raw:"TypeColumn[]"},description:""},rows:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  options?: TypeOption[];
  value?: string;
