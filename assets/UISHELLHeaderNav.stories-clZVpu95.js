import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{r as o}from"./index-CTjT7uj6.js";import{d as i}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as n}from"./contextual-D4vCP4YA.js";import{A as S,L as T}from"./IconsInputLabel-DNdvQB1m.js";import{T as x}from"./index-CKOFa-r3.js";const $=i.div`
...
`,W=i.h1`
  ...
  line-height: 18px !important;
  letter-spacing: 0.16px;
`,b=y=>{const{options:l,icon:M,userName:H,emailuser:V,children:j,SectionRightTime:v,bgHeader:R}=y,[p,a]=o.useState(!1),[g,k]=o.useState(),N=t=>{g===t&&p?a(!1):(k(t),a(!0))},d=o.useRef(null),m=t=>{d.current&&!d.current.contains(t.target)&&a(!1)};return o.useEffect(()=>(document.addEventListener("mousedown",m),()=>{document.removeEventListener("mousedown",m)}),[]),e.jsxs(B,{children:[e.jsxs(L,{style:{background:R||n.focus},children:[e.jsx(I,{children:M}),e.jsxs(P,{children:[e.jsxs(O,{children:[e.jsx("section",{style:{margin:"0",padding:".5em",background:"gray",display:"flex",alignItems:"center",borderRadius:"100%"},children:_}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",margin:"0",padding:"0",fontFamily:"IBM Plex Sans",fontSize:"13px"},children:[e.jsx(Y,{children:H}),e.jsx(G,{children:V})]})]}),j||e.jsxs(D,{children:[e.jsx(x,{align:"bottom",label:"Notificações",size:"medium",children:e.jsx("section",{style:{margin:"10px 0",padding:"0"},children:F})}),e.jsx(x,{align:"bottom-right",label:"Ajuda",size:"medium",width:"55px",children:e.jsx("section",{style:{margin:"10px 0",padding:"0"},children:U})})]})]})]}),e.jsxs($,{ref:d,children:[e.jsx("div",{style:{margin:"0 2px",padding:"0",display:"flex",position:"relative",alignItems:"center",height:"auto",gap:"2px"},children:l==null?void 0:l.map((t,c)=>{var u;return e.jsxs(q,{style:{margin:"0",padding:"0",alignItems:"center"},children:[t.permission&&e.jsx("a",{href:t.href,children:e.jsxs(z,{onClick:t.optionsMenu?()=>N(c):t.onClick,children:[t.label,t.optionsMenu?S:""]})}),g===c&&p&&e.jsx("div",{style:{position:"absolute",margin:"0",padding:"0",background:"green",top:"55px"},children:e.jsx(E,{children:(u=t.optionsMenu)==null?void 0:u.map((r,Z)=>r.permission&&e.jsx(A,{onClick:()=>{var h;(h=r.onClick)==null||h.call(r),a(!1)},children:r.label},Z))})})]},c)})}),e.jsx("div",{style:{margin:"0 1em",padding:"0",fontFamily:"IBM Plex Sans",fontSize:"15px",display:"flex",alignItems:"center"},children:e.jsx(W,{children:v})})]})]})};b.__docgenInfo={description:"",methods:[],displayName:"UIHeaderNav",props:{options:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
...
}`,...(w=(f=s.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};const le=["Default"];export{s as Default,le as __namedExportsOrder,se as default};
