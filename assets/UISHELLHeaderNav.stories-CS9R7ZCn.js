import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{r as d}from"./index-CTjT7uj6.js";import{d as n}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */import{t as i}from"./contextual-D4vCP4YA.js";import{A as q,L as z}from"./IconsInputLabel-E66WMmAT.js";import{T as g}from"./index-UMtQnabN.js";const L=n.div`
...
`,Q=n.div`
  ...
  line-height: 18px !important;
  letter-spacing: 0.16px;
`,v=V=>{const{options:o,icon:j,userName:H,emailuser:M,children:R,SectionRightTime:k,bgHeader:m,navigateProfile:N}=V,[h,l]=d.useState(!1),[u,x]=d.useState(),[Z,T]=d.useState(),$=(t,s)=>{var a,r;T(t),s?u===t&&h?l(!1):(x(t),l(!0)):(x(void 0),l(!1),(r=(a=o==null?void 0:o[t])==null?void 0:a.onClick)==null||r.call(a))},p=d.useRef(null),C=t=>{p.current&&!p.current.contains(t.target)&&l(!1)};return d.useEffect(()=>(document.addEventListener("mousedown",C),()=>{document.removeEventListener("mousedown",C)}),[]),e.jsxs(B,{children:[e.jsxs(E,{style:{background:m||i.focus},children:[e.jsx(A,{children:j}),e.jsxs(D,{children:[e.jsxs(I,{children:[e.jsx(g,{align:"bottom",size:"small",label:"Meu perfil",width:"100px",children:e.jsx("section",{onClick:N,style:{margin:"0",padding:".5em",background:"gray",display:"flex",alignItems:"center",borderRadius:"100%"},children:W})}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",margin:"0",padding:"0",fontSize:"13px"},children:[e.jsx(J,{children:H}),e.jsx(K,{children:M})]})]}),R||e.jsxs(F,{children:[e.jsx(g,{align:"bottom",label:"Notificações",size:"medium",children:e.jsx("section",{style:{margin:"10px 0",padding:"0"},children:Y})}),e.jsx(g,{align:"bottom-right",label:"Ajuda",size:"medium",width:"55px",children:e.jsx("section",{style:{margin:"10px 0",padding:"0"},children:G})})]})]})]}),e.jsxs(L,{ref:p,children:[e.jsx("div",{style:{margin:"0 2px",padding:"0",display:"flex",position:"relative",alignItems:"center",height:"auto",gap:"2px"},children:o==null?void 0:o.map((t,s)=>{var a;return e.jsxs(O,{style:{margin:"0",padding:"0",alignItems:"center"},children:[t.permission&&e.jsx("a",{href:t.href,children:e.jsxs(P,{style:{borderBottom:Z===s?`2px solid ${m}`:"2px solid transparent"},onClick:()=>$(s,!!t.optionsMenu),children:[t.label,t.optionsMenu?q:""]})}),u===s&&h&&t.optionsMenu&&e.jsx("div",{style:{position:"absolute",margin:"0",padding:"0",top:"55px"},children:e.jsx(U,{children:(a=t.optionsMenu)==null?void 0:a.map((r,S)=>r.permission&&e.jsx(_,{onClick:()=>{var f;(f=r.onClick)==null||f.call(r),l(!1)},children:r.label},S))})})]},s)})}),e.jsx("div",{style:{margin:"0 1em",padding:"0",fontSize:"15px",display:"flex",alignItems:"center",height:"auto"},children:e.jsx(Q,{children:k})})]})]})};v.__docgenInfo={description:"",methods:[],displayName:"UIHeaderNav",props:{options:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
  ...
  onClick?: () => void;\r
  permission?: boolean;\r
}`,signature:{properties:[{key:"label",value:{name:"string",required:!1}},{key:"onClick",value:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}},required:!1}},{key:"permission",value:{name:"boolean",required:!1}}]}}],raw:"TypeOption[]",required:!1}}]}}],raw:"TypeMenu[]"},description:""},icon:{required:!1,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},emailuser:{required:!1,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},userName:{required:!1,tsType:{name:"union",raw:"string | React.ReactNode",elements:[{name:"string"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},SectionRightTime:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},open:{required:!1,tsType:{name:"boolean"},description:""},bgHeader:{required:!1,tsType:{name:"string"},description:""},navigateProfile:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const ce={title:"Example/UIHeaderNav",component:v,parameters:{layout:"centered"},tags:["autodocs"]},X=[{label:"Sobre Nos",permission:!0,optionsMenu:[{label:"1"},{label:"1"},{label:"1"},{label:"3",permission:!0}]},{label:"Perfil",permission:!0,optionsMenu:[{label:"Menu 2",onClick:()=>alert("clickou no meu 2"),permission:!0},{label:"Menu 2",permission:!0},{label:"Menu 2"},{label:"Menu 2"}]},{label:"Tikets",permission:!0,optionsMenu:[{label:"Menu 2",permission:!0},{label:"Menu 2"},{label:"Menu 2"},{label:"Menu 2"}]},{label:"Menu",permission:!0},{label:"Chamados",onClick:()=>alert("Chamados")}],ee=new Date().getDate(),ie=new Date().getMonth()+1,ne=new Date().getFullYear(),c={args:{options:X,icon:z,emailuser:"teste@gmail.com",userName:"teste@teste",SectionRightTime:`${ee}/${ie}/${ne}`,navigateProfile:()=>alert("")}};var w,b,y;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    options: arrNew,
    icon: LogoProsperita,
...
}`,...(y=(b=c.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const pe=["Default"];export{c as Default,pe as __namedExportsOrder,ce as default};
