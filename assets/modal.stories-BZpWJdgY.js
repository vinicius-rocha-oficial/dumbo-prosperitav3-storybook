import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{r as m}from"./index-CTjT7uj6.js";import{B as T}from"./index-CMqduQi4.js";import{C}from"./IconsInputLabel-NZUeNpyL.js";import{d as n,t as s}from"./contextual-Cr4fQ3MC.js";/* empty css              */import"./index-ClYmvwGD.js";/* empty css                 */const q=n.div`
...
`,P=n.p`
  ...
  width: 95%;
  word-wrap: break-word;
`,f=i=>{const{label:h,textLabel:y,buttons:o,type:v,open:w,children:k,onClose:t}=i,[c,u]=m.useState(!1),l=m.useRef(null),p=r=>{l.current&&!l.current.contains(r.target)&&(u(!1),t==null||t())};m.useEffect(()=>(document.addEventListener("mousedown",p),()=>{document.removeEventListener("mousedown",p)}),[w]);const j=(r,a)=>a===0&&o.length===3?"70%":"50%";return e.jsx(e.Fragment,{children:e.jsx(q,{open:c,...i,children:e.jsxs(z,{open:c,ref:l,...i,children:[e.jsxs(R,{children:[e.jsxs(S,{children:[e.jsx($,{children:h}),e.jsx(P,{children:y})]}),e.jsx(M,{onClick:()=>{u(!1),t==null||t()},children:C})]}),e.jsx(B,{children:e.jsx(L,{children:k||e.jsx(e.Fragment,{})})}),e.jsx(E,{children:o==null?void 0:o.map((r,a)=>e.jsx("div",{style:{width:j(r,a),boxSizing:"border-box"},children:e.jsx(T,{forModal:!0,size:"large",kind:r.kind||"secondary",label:r.label,url:r.icon,disabled:r.disabled,onClick:r.onClick,type:v,style:{borderRadius:a===o.length-1?"0 0 8px 0":a===0?"0 0 0 8px":"0",boxSizing:"border-box"}})},a))})]})})})};f.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{label:{required:!1,tsType:{name:"string"},description:""},textLabel:{required:!1,tsType:{name:"string"},description:""},buttons:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label?: string;
  icon?: string;
  onClick?: () => void;
  disabled?: boolean;
