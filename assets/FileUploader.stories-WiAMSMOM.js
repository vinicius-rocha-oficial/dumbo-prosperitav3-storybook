import{j as t}from"./jsx-runtime-Cw0GR0a5.js";import{r as p}from"./index-CTjT7uj6.js";import{d as a}from"./styled-components.browser.esm-D3-gLipQ.js";import{t as i}from"./contextual-D4vCP4YA.js";/* empty css              */import{C as ne,g as ie}from"./IconsInputLabel-C-_tevyj.js";import{w as re}from"./Warningfilled-CR6tEm8M.js";import{S as ae,a as b}from"./index-ClYmvwGD.js";import{I as le}from"./index-IwwrmtMF.js";import{M as oe}from"./index-BU-lGxT0.js";import"./index-rNDKbjlC.js";import"./index-9Jiz9iCi.js";/* empty css                 */import"./index-CXvTuBB8.js";const H={small:"7px 64px 7px 16px",large:"15px 64px 15px 16px",medium:"11px 64px 11px 16px"},q=a.div`
  display: flex;
...
`,R=a.div`
  ...
  align-self: start;
  margin: 0;
`,Y=e=>{const{type:s,onChange:d,onDelete:S,disabled:j,maxlenghtindividual:w,errormessege:c,accept:g,loading:G,multiple:v,headers:r,name:F,children:u}=e,[m,T]=p.useState([]),[J,$]=p.useState(!1),[K,L]=p.useState([]),[Q,D]=p.useState(!1),[k,V]=p.useState(null),W=n=>{const l=m[n];l&&(V(URL.createObjectURL(l)),D(!0))};p.useEffect(()=>{const n=setTimeout(()=>{L(()=>[...m.filter(o=>o.name).map(o=>o.name)])},500);return()=>clearTimeout(n)},[m]);const z=n=>{n.stopPropagation();const l=Array.from(n.target.files||[]);T(o=>{const x=l.filter(I=>!o.some(C=>C.name===I.name));return[...o,...x]}),d&&d(n)},X=n=>{T(l=>l.filter((o,x)=>x!==n)),L(l=>l.filter(o=>o!==n)),S&&S(n)},Z=n=>{n.preventDefault(),$(!0)},ee=()=>{$(!1)},te=n=>{n.preventDefault(),$(!1);const l=Array.from(n.dataTransfer.files);if(T(o=>{const x=l.filter(I=>!o.some(C=>C.name===I.name));return[...o,...x]}),d){const o={...n,target:{files:n.dataTransfer.files}};d(o)}},f={position:"absolute",right:"0",bottom:"0",left:"0",top:"0",display:"flex",margin:"0"};return t.jsx(t.Fragment,{children:G?t.jsx(t.Fragment,{children:t.jsxs(ae,{baseColor:i.skeletonElement,highlightColor:i.skeletonBackground,children:[((r==null?void 0:r.label)||(r==null?void 0:r.TextLabel))&&t.jsxs(O,{...e,children:[t.jsx(R,{children:t.jsxs(N,{style:{position:"relative"},...e,children:[r==null?void 0:r.label,t.jsx(b,{count:1,style:f})]})}),t.jsx(R,{children:t.jsxs(M,{style:{position:"relative"},...e,children:[r==null?void 0:r.TextLabel,t.jsx(b,{count:1,style:f})]})})]}),t.jsx(q,{...e,children:s==="default"?t.jsxs(E,{...e,children:[u,t.jsx(h,{}),t.jsx(b,{count:1,style:f})]}):t.jsxs(P,{...e,style:{position:"relative"},children:[t.jsx(U,{...e,children:u}),t.jsx(h,{}),t.jsx(b,{count:1,style:f})]})})]})}):t.jsxs(t.Fragment,{children:[((r==null?void 0:r.label)||(r==null?void 0:r.TextLabel))&&t.jsxs(O,{...e,children:[t.jsx(N,{...e,children:r==null?void 0:r.label}),t.jsx(M,{...e,children:r==null?void 0:r.TextLabel})]}),t.jsxs(q,{...e,children:[s==="default"?t.jsxs(E,{...e,children:[u,t.jsx(h,{accept:g,type:"file",onChange:z,multiple:v,disabled:j,name:F})]}):t.jsxs(P,{...e,onDragOver:Z,onDragLeave:ee,onDrop:te,on:J,disabled:j,accept:g,name:F,multiple:v,children:[t.jsx(U,{...e,children:u}),t.jsx(h,{accept:g,type:"file",onChange:z,disabled:j,name:F,multiple:v})]}),t.jsxs(se,{...e,children:[m.map((n,l)=>t.jsxs(de,{error:Number((n.size/(1024*1024)).toFixed(5))>=w,...e,children:[t.jsxs(me,{...e,children:[t.jsx(ce,{children:n.name}),t.jsxs(xe,{...e,children:[t.jsx(pe,{children:K.includes(n.name)?t.jsx("span",{onClick:()=>X(l),children:ne}):t.jsx(le,{status:"active"})}),t.jsx(ge,{onClick:()=>W(l),...e,children:ie}),Number((n.size/(1024*1024)).toFixed(5))>=w&&t.jsx("img",{src:re})]})]}),Number((n.size/(1024*1024)).toFixed(5))>=w&&t.jsxs("div",{style:{margin:"13px 0 0 0",padding:"0",borderTop:`1px solid ${i.borderStrong01}`,width:"100%"},children:[t.jsx(fe,{children:c==null?void 0:c.label}),t.jsx(ue,{children:c==null?void 0:c.InvalidText})]},l)]},n.name)),m.length>0&&t.jsx(oe,{buttons:[{label:"Fechar",kind:"dangerPrimary",onClick:()=>D(!1)}],open:Q,onClose:()=>D(!1),children:k&&t.jsx(t.Fragment,{children:g===".pdf"?t.jsx(t.Fragment,{children:t.jsx("iframe",{src:k,style:{overflowY:"hidden",width:"100%",height:"100%",border:0,display:"flex",justifyContent:"center",alignItems:"center"}})}):t.jsx(t.Fragment,{children:t.jsx("img",{style:{width:"100%",height:"100%",objectFit:"contain"},src:k})})})})]})]})]})})};Y.__docgenInfo={description:"",methods:[],displayName:"FileUploader",props:{size:{required:!0,tsType:{name:"union",raw:'"small" | "large" | "medium"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"large"'},{name:"literal",value:'"medium"'}]},description:""},type:{required:!0,tsType:{name:"union",raw:'"drag and top" | "default"',elements:[{name:"literal",value:'"drag and top"'},{name:"literal",value:'"default"'}]},description:""},onDelete:{required:!1,tsType:{name:"signature",type:"function",raw:"(index: number) => void",signature:{arguments:[{type:{name:"number"},name:"index"}],return:{name:"void"}}},description:""},on:{required:!1,tsType:{name:"boolean"},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},error:{required:!1,tsType:{name:"boolean"},description:""},errormessege:{required:!1,tsType:{name:"signature",type:"object",raw:`{\r
  label?: string;\r
