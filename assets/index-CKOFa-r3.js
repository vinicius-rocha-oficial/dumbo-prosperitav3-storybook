import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{d as o}from"./styled-components.browser.esm-D3-gLipQ.js";/* empty css              */const r={top:"center","top-left":"start","top-right":"end",bottom:"center","bottom-left":"start","bottom-right":"end",left:"start",right:"end"},n=o.div`
  display: flex;
...
`,p=o.div`
  ...
  opacity: 1;
  word-wrap: break-word;
  justify-content: ${({align:t})=>r[t||"top"]};
  font-family: "IBM Plex Sans";
  color: white;
  word-wrap: break-word;
  font-size: 14px;
